...
- `kymflow/src/kymflow/core/analysis/heart_rate/docs/`
...
kymflow/src/kymflow/core/analysis/heart_rate/tickets/<ticket_name>_codex_report.md
...
3) **Scope confirmation**
   - Explicitly confirm:
     a) No files outside `kymflow/src/kymflow/core/analysis/heart_rate/` were modified.

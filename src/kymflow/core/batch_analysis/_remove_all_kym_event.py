...
def _delete_all_kym_event(path:str):
    ...
    for kymImage in kymList:
        ...
        for roi_id in kymImage.rois.get_roi_ids():
            ...
            # reanalyze kym events
            logger.info(f'  === rerun with run_velocity_event_analysis()')
            ka.run_velocity_event_analysis(roi_id)
            logger.info(f'  final events n is:{ka.num_velocity_events(roi_id)}')
...
if __name__ == "__main__":
    ...
    path = '/Users/cudmore/Dropbox/data/declan/2026/compare-condiitons/declan-stall-v1/_declan-random-v1.csv'

    # path = '/Users/cudmore/Dropbox/data/declan/2026/compare-condiitons/declan-stall-v1'

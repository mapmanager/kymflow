"""State containers with callback registries (psygnal-free).

This module replaces psygnal signals with simple callback registries,
eliminating lifecycle issues with NiceGUI component cleanup.
"""
...
class TaskState:
    ...
    Uses callback registries instead of psygnal signals.
    """

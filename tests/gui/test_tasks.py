...
@pytest.fixture
def sample_kym_file() -> KymFile:
    """Create a sample KymFile for testing."""
...
def test_run_flow_analysis_creates_roi_if_none_exists(sample_kym_file: KymFile) -> None:
...
def test_run_flow_analysis_uses_existing_roi(sample_kym_file: KymFile) -> None:
...
def test_run_batch_flow_analysis_creates_rois(sample_kym_file: KymFile) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        def on_file_complete(kf: KymFile) -> None:
...
def test_run_flow_analysis_cancellation(sample_kym_file: KymFile) -> None:

...
from kymflow.core.kym_file import KymFile, KymFileList
...
def test_kymfilelist_collect_metadata() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        metadata_list = file_list.collect_metadata(include_analysis=False)
        ...
        metadata_with_analysis = file_list.collect_metadata(include_analysis=True)
...
def test_kymfilelist_iter_metadata() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        metadata_iter = file_list.iter_metadata(include_analysis=False)
